...
public class ApplicationConfigServiceTest {
    ...
    private static final Logger LOGGER = LoggerFactory.getLogger(ApplicationConfigServiceTest.class);
    ...
    public void testCreateAppServiceRequiredBadWithExistSerName() {
        try {
            ...
            Assert.assertEquals("create serviceRequired failed: serName have exit", e.getMessage());
        }
    }
