...
MERGE INTO tbl_container_image (image_id, image_name, image_version, user_id, user_name,image_path)  KEY(image_id) values
( '6ababcec-2934-43d9-afc8-d3d403ebc782','test1','1.0','c5c7c35a-f85b-441c-9307-5516b951efd2','author','1.1.1.1/developer/test1:1.0');
--
...
-- ----------------------------
MERGE INTO tbl_vm_image KEY(id) VALUES(1, 'Ubuntu18.04', 'public', 'ubuntu', '18.04', '64', 40, 'virtio', 1.0, 'Ubuntu18.04.qcow2', 'qcow2', null, null, 1024000, null, 'UPLOAD_WAIT', '2020-03-18 16:19:36.127+08', '2020-03-18 16:19:36.127+08', null, '39937079-99fe-4cd8-881f-04ca8c4fe09d', 'admin', null, null);
MERGE INTO tbl_vm_image KEY(id) VALUES(2, 'Ubuntu16.04', 'public', 'ubuntu', '16.04', '64', 40, 'virtio', 1.0, 'Ubuntu16.04.qcow2', 'qcow2', 'test', null, 1024000, null, 'UPLOAD_WAIT', '2020-03-18 16:19:36.127+08', '2020-03-18 16:19:36.127+08', null, '39937079-99fe-4cd8-881f-04ca8c4fe09d', 'admin', null, null);
MERGE INTO tbl_vm_image KEY(id) VALUES(3, 'Ubuntu14.04', 'public', 'ubuntu', '14.04', '64', 40, 'virtio', 1.0, 'Ubuntu14.04.qcow2', 'qcow2', 'url', null, 1024000, null, 'UPLOAD_WAIT', '2020-03-18 16:19:36.127+08', '2020-03-18 16:19:36.127+08', null, '39937079-99fe-4cd8-881f-04ca8c4fe09d', 'admin', null, null);
MERGE INTO tbl_vm_image KEY(id) VALUES(4, 'Ubuntu12.04', 'public', 'ubuntu', '12.04', '64', 40, 'virtio', 1.0, 'Ubuntu12.04.qcow2', 'qcow2', null, null, 1024000, null, 'UPLOAD_WAIT', '2020-03-18 16:19:36.127+08', '2020-03-18 16:19:36.127+08', null, 'd1bb89fe-1a9d-42e9-911e-7b038c3480b9', 'admin', null, null);
MERGE INTO tbl_vm_image KEY(id) VALUES(5, 'Ubuntu10.04', 'public', 'ubuntu', '10.04', '64', 40, 'virtio', 1.0, 'Ubuntu10.04.qcow2', 'qcow2', null, null, 1024000, null, 'UPLOADING_MERGING', '2020-03-18 16:19:36.127+08', '2020-03-18 16:19:36.127+08', null, 'd1bb89fe-1a9d-42e9-911e-7b038c3480b9', 'admin', null, null);
