...
--           (1, 'ubuntu-18.04', 'public', 'ubuntu', '18.04', '64', 40, '39937079-99fe-4cd8-881f-04ca8c4fe09d', 'admin', '2020-05-28 00:00:00.000000', '2020-05-28 00:00:00.000000', 'qcow2','2020-05-28 00:00:00.000000','http://192.168.100.106:80/image-management/v1/images/49dc9b6345a34ce8b2872262698ad3c5/action/download', 'ubuntu_18_04.qcow2', '36fcf66940532088b6081512557528b3', 'PUBLISHED');
    ...
    ('init-n6', 'init-application', 'N6 network, when end-side devices access edge applications, they need to access through this network', 'Network_n6')
    ON CONFLICT(id) do nothing;
    INSERT INTO tbl_network (id, app_id, description, name)
    VALUES ('init-mep', 'init-application', 'The network with the edge computing platform, when the application has service dependency or needs to publish the service, the network is needed', 'Network_MEP')
    ON CONFLICT(id) do nothing;
    INSERT INTO tbl_network (id, app_id, description, name) VALUES
    ('init-internet', 'init-application', 'Internet Network', 'Network_Internet')
    ON CONFLICT(id) do nothing;
