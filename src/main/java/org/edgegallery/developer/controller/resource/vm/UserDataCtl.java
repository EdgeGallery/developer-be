...
@RequestMapping("/mec/developer/v2/user-datas")
@Api(tags = "userdata")
public class UserDataCtl {
    ...
    public ResponseEntity<String> getUserdata(
        @ApiParam(value = "osType", required = true) @QueryParam("osType") String osType,
        @ApiParam(value = "pkgSpecId", required = true) @QueryParam("pkgSpecId") String pkgSpecId) {
        return ResponseEntity.ok(userDataService.getUserData(osType, pkgSpecId));
    }
