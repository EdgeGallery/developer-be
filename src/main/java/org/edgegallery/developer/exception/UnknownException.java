...
public class UnknownException extends RuntimeException {
    ...
    private static final long serialVersionUID = 1646444285623052460L;
     ...
     * @param ret retCode
     */
    public UnknownException(String message, int ret) {
        super(message);
     ...
     */
    public UnknownException(String message, int ret, Object... args) {
        super(message);
