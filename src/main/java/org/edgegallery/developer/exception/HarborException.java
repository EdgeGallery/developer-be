...
public class HarborException extends RuntimeException implements Serializable {

    private static final long serialVersionUID = 1646444285623052458L;
     ...
     * @param ret retCode
     */
    public HarborException(String message, int ret) {
        super(message);
