...
public class ApplicationProject {
     ...
     * @return
     */
    public List<ApplicationProjectCapability> getApplicationProjectCapabilities() {
        if (CollectionUtils.isEmpty(capabilityList)) {
            return Collections.emptyList();
        }
        return capabilityList.stream().map(new Function<String, ApplicationProjectCapability>() {
            @Override
            public ApplicationProjectCapability apply(String capabilityId) {
                return ApplicationProjectCapability.newInstance(getId(), capabilityId);
            }
