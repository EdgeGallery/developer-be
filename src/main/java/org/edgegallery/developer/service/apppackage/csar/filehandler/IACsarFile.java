...
public interface IACsarFile {
     ...
     * @return boolean
     */
    boolean delContentByTypeAndValue(IToscaContentEnum type, String value);
    ...
    IContentParseHandler getContentByTypeAndValue(IToscaContentEnum type, final String value);
}
