...
public class VMAppOperationServiceImpl extends AppOperationServiceImpl implements VmAppOperationService {
    ...
    @Override
    public Either<FormatRespDto, OperationInfoRep> instantiateVmApp(String applicationId, String vmId, String accessToken) {
        ...
        return Either.right(new OperationInfoRep(operationStatus.getId()));
    }
